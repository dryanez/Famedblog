                ...
                <div>
                    ...
                    {showPreview ? (
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-mono text-base min-h-[500px] text-black bg-white placeholder-gray-500"
