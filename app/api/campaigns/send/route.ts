...
export async function POST(request: Request) {
    try {
        ...
        console.log(`[DEBUG] Step 3: Users prepared. Count: ${users.length}`);
        ...
        console.log('[DEBUG] Step 4.1: Content generation complete');

        if (targetUsers.length === 0) {
            console.log('[DEBUG] Step 4.2: No users to send to');
            // ...
        }
